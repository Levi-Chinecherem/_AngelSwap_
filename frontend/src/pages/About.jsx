...
const AboutPage = () => {
  return (
    <main className="bg-sciFiBg text-sciFiText font-sans">
      ...
      <section id="about" className="relative min-h-screen flex items-center justify-center text-center p-4 bg-gradient-to-b from-sciFiBg via-gray-900 to-gray-900 overflow-hidden">
      ...
      {/* About Content Section with enhanced cards */}
            ...
            {[
              {
                ...
                content: "At AngelSwap, we believe in the power of decentralization and transparency. Built on PulseChain, we ensure lightning-fast transactions with minimal fees, making it an ideal platform for anyone looking to swap tokens efficiently."
              },
              {
                title: "Accessible to Everyone",
                content: "Whether you're a seasoned trader or a newcomer to the world of decentralized finance (DeFi), AngelSwap offers a secure and accessible platform for all your token-swapping needs."
              },
              {
                title: "Superior Scalability",
                content: "Our platform leverages the strengths of PulseChain to offer superior scalability and a robust ecosystem for its users. With a focus on user experience and scalability, AngelSwap is the next evolution in decentralized token swaps."
              }
            ].map((item, index) => (
              <div
                key={index}
